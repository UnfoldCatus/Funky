    ...
    return (
      <div style={{width:'100%',marginTop:'0px',marginBottom:'0px',marginLeft:'auto',marginRight:'auto' ,position:'relative',overflow:'hidden'}}>
        <div style={{width:'1920px',position:'relative',left:'50%',marginLeft:'-960px'}} >
            <img src="http://img2.jsbn.com/static/tjbg_01.jpg" style={{display:'block'}}/>
            <img src="http://img2.jsbn.com/static/tjbg_02.jpg" style={{display:'block'}}/>
            <img src="http://img2.jsbn.com/static/tjbg_03.jpg" style={{display:'block'}}/>
