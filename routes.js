...
apiRouter.get('/', function* apiRoot(next) {
  ...
  this.body = {
    '/api/adv/all':'广告',
    '/api/sample/:position?***':'作品',
    '/api/pringles/:position':'客片',
    '/api/pringlesSeason/list':'客片分季',
    '/api/hotel/:position?***':'酒店列表',
    '/api/banquetHall/list?hotelId=*':'获取宴会厅列表',
    '/api/hotelType/all':'婚宴预订-酒店类型搜索条件',
    '/api/hotelDistrict/all': '婚宴预订-酒店区域搜索条件',
    '/api/suite/all':'套系',
    '/api/cases/:position?***':'实景案例',
    '/api/case3D/:position':'3D案例',
    '/api/caseStyle/all':'婚庆定制-案例风格搜索条件',
    '/api/followPhoto/:position':'婚礼跟拍',
    ...
    '/api/recordVideo/:position': '婚纱摄影-纪实MV',
